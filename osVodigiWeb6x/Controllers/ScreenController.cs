    ...
    public class ScreenController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                ViewData["ScreenTypeList"] = new SelectList(BuildScreenTypeList(), "Value", "Text");//, "Slayt Şov"
                if (Request.Form["lstScreenTypeList"] != null)
                {                   
                    pagestate.ScreenTypeID = Request.Form["lstScreenTypeList"].ToString().Trim();
                }
                else
                {
                ...
                if (Request.Form["txtScreenName"] != null)
                {
                ...
                //ViewData["ScreenTypeList"] = pagestate.ScreenTypeID;
                ...
                IEnumerable<Screen> screens = repository.GetScreenPage(pagestate.AccountID, pagestate.ScreenName, pagestate.Description, pagestate.IncludeInactive,pagestate.ScreenTypeID, pagestate.SortBy, isdescending, pagestate.PageNumber, pagecount);
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        CommonMethods.CreateActivityLog((User)Session["User"], "Screen", "Add",
                            "Ekran eklendi '" + screen.ScreenName + "' - ID: " + screen.ScreenID.ToString());
        ...
        private List<SelectListItem> BuildScreenTypeList()
        {
            // Build the list
            ...
            item1.Text = "Slayt Şov";
            item1.Value = "Slayt Şov";
        ...
        private string ValidateInput(Screen screen)
        {
            ...
            if (String.IsNullOrEmpty(screen.ScreenName))
                return "Screen Name zorunludur.";

            if (screen.SlideShowID == 0 && screen.PlayListID == 0)
                return "You must select a Slayt Şov or Play List.";

            if (screen.SlideShowID != 0 && screen.PlayListID != 0)
                return "Select a Slayt Şov or Play List. You cannot select both.";
