        ...
        private string BuildSurveyTable(Survey survey)
        {
            try
            {
                ...
                foreach (SurveyQuestion question in questions)
                {
                    ...
                    sb.AppendLine("<td class=\"gridtext\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestionOption/Create/" + question.SurveyQuestionID.ToString() + "'\">Özellik Ekle</span></td>");
                    sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestion/MoveUp/" + question.SurveyQuestionID.ToString() + "'\">Yukarı</span></td>");
                    sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestion/MoveDown/" + question.SurveyQuestionID.ToString() + "'\">Aşağı</span></td>");
                    sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestion/Edit/" + question.SurveyQuestionID.ToString() + "'\">Düzenle</span></td>");
                    sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestion/Delete/" + question.SurveyQuestionID.ToString() + "'\">Sil</span></td>");
                    sb.AppendLine("</tr>");
                    ...
                    foreach (SurveyQuestionOption option in options)
                    {
                        ...
                        sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestionOption/MoveUp/" + option.SurveyQuestionOptionID.ToString() + "'\">Yukarı</span></td>");
                        sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestionOption/MoveDown/" + option.SurveyQuestionOptionID.ToString() + "'\">Aşağı</span></td>");
                        sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestionOption/Edit/" + option.SurveyQuestionOptionID.ToString() + "'\">Düzenle</span></td>");
                        sb.AppendLine("<td class=\"gridtext\" style=\"text-align:center;\"><span class=\"surveyquestionoptionlink\" onclick=\"window.location='" + root + "SurveyQuestionOption/Delete/" + option.SurveyQuestionOptionID.ToString() + "'\">Sil</span></td>");
                        sb.AppendLine("</tr>");
                    }
                }
