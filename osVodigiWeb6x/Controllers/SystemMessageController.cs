                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        CommonMethods.CreateActivityLog((User)Session["User"], "SystemMessage", "Add",
                            "Sistem mesajı eklendi '" + systemmessage.SystemMessageTitle + "' - ID: " + systemmessage.SystemMessageID.ToString());
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    CommonMethods.CreateActivityLog((User)Session["User"], "System Message", "Edit",
                                                    "Sistem mesajı güncellendi '" + systemmessage.SystemMessageTitle + "' - ID: " + systemmessage.SystemMessageID.ToString());
