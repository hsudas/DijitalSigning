    ...
    public class MusicController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                if (Request.Form["txtMusicName"] != null)
                {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        CommonMethods.CreateActivityLog((User)Session["User"], "Music", "Add",
                                "Müzik eklendi '" + music.MusicName + "' - ID: " + music.MusicID.ToString());
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    CommonMethods.CreateActivityLog((User)Session["User"], "Music", "Edit",
                            "Müzik güncellendi '" + music.MusicName + "' - ID: " + music.MusicID.ToString());
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (file != null && file.ContentLength > 0 && !String.IsNullOrEmpty(file.FileName))
                    {
                        ...
                        else
                        {
                            ...
                            {
                                ViewData["ValidationMessage"] = "Sadece .mp3 ve .wma müzik dosyaları yüklenebilir.";
                            }
                            else
                            {
                    ...
                    else
                    {
                        ...
                        CommonMethods.CreateActivityLog((User)Session["User"], "Music", "Upload",
                                "Müzik yüklendi '" + music.MusicName + "' - ID: " + music.MusicID.ToString());
        ...
        private string ValidateInput(Music music)
        {
            ...
            if (music.OriginalFilename == "0" || String.IsNullOrEmpty(music.OriginalFilename))
                return "Geçerli bir müzik seçmelisiniz.";

            if (String.IsNullOrEmpty(music.MusicName))
                return "Müzik Adı gereklidir.";
