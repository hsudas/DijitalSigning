    ...
    public class SlideShowController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                if (Request.Form["txtSlideShowName"] != null)
                {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        CommonMethods.CreateActivityLog((User)Session["User"], "Slayt Şov", "Add",
                            "Slayt Şov eklendi '" + slideshow.SlideShowName + "' - ID: " + slideshow.SlideShowID.ToString());
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        CommonMethods.CreateActivityLog((User)Session["User"], "Slayt Şov", "Edit",
                            "Slayt Şov güncellendi '" + slideshow.SlideShowName + "' - ID: " + slideshow.SlideShowID.ToString());
        ...
        private string ValidateInput(SlideShow slideshow, string sImages)
        {
            ...
            if (String.IsNullOrEmpty(slideshow.SlideShowName))
                return "Slayt Şov Name zorunludur.";

            if (String.IsNullOrEmpty(sImages.Replace("|", "")))
                return "You must select at least one image for this Slayt Şov.";
