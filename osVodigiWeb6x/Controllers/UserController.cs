    ...
    public class UserController : Controller
    {
        ...
        public ActionResult Index()
        {
            try
            {
                ...
                ViewData["LoginInfo"] = "<b>Kullanıcı:</b> " + currentuser.Username + "&nbsp; &nbsp; &nbsp;<b>Hesap:</b> " + Session["UserAccountName"];
                ...
                if (ModelState.IsValid)
                {
                    ...
                    else
                    {
                        ...
                        CommonMethods.CreateActivityLog((User)Session["User"], "User", "Add",
                            "Kullanıcı eklendi '" + user.Username + "' - ID: " + user.UserID.ToString());
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    CommonMethods.CreateActivityLog((User)Session["User"], "User", "Edit",
                        "Kullanıcı güncellendi '" + user.Username + "' - ID: " + user.UserID.ToString());
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    CommonMethods.CreateActivityLog((User)Session["User"], "User", "Change Password",
                        "Şifre değiştirildi , değişen kullanıcı : '" + user.Username + "' - ID: " + user.UserID.ToString());
        ...
        private string ValidateInput(User user, string confirmpassword, bool isEdit, bool passwordchanged)
        {
            ...
            if (String.IsNullOrEmpty(user.EmailAddress))
                return "Email address zorunludur.";
