    ...
    public class PlayerController : Controller
    {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    CommonMethods.CreateActivityLog((User)Session["User"], "Player", "Add",
                            "Player eklendi '" + player.PlayerName + "' - ID: " + player.PlayerID.ToString());
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    CommonMethods.CreateActivityLog((User)Session["User"], "Player", "Edit",
                            "Player güncellendi '" + player.PlayerName + "' - ID: " + player.PlayerID.ToString());
        ...
        private string ValidateInput(Player player)
        {
            ...
            if (player.PlayerGroupID == 0)
                return "Player Group zorunludur.";

            if (String.IsNullOrEmpty(player.PlayerName))
                return "Player Name zorunludur.";
